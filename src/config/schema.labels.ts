...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "gateway.summaryService": "Gateway Summary Service",
  "gateway.summaryService.enabled": "Gateway Summary Service Enabled",
  "gateway.summaryService.configPath": "Gateway Summary Service Config Path",
  "gateway.summaryService.instances": "Gateway Summary Service Instances",
  "gateway.summaryService.baseUrl": "Gateway Summary Service Base URL",
  "gateway.summaryService.apiKey": "Gateway Summary Service API Key",
  "gateway.summaryService.model": "Gateway Summary Service Model",
  "gateway.summaryService.redisUrl": "Gateway Summary Service Redis URL",
  "gateway.summaryService.jobStream": "Gateway Summary Service Job Stream",
  "gateway.summaryService.resultStream": "Gateway Summary Service Result Stream",
  "gateway.summaryService.consumerGroup": "Gateway Summary Service Consumer Group",
  "gateway.summaryService.consumerName": "Gateway Summary Service Consumer Name",
  "gateway.summaryService.port": "Gateway Summary Service Port",
  "gateway.summaryService.claimIdleMs": "Gateway Summary Service Claim Idle (ms)",
  ...
  "agents.defaults.compaction.summaryOffload": "Summary Offload",
  "agents.defaults.compaction.summaryOffload.enabled": "Summary Offload Enabled",
  "agents.defaults.compaction.summaryOffload.queue.redisUrl": "Summary Offload Redis URL",
  "agents.defaults.compaction.summaryOffload.queue.jobStream": "Summary Offload Job Stream",
  "agents.defaults.compaction.summaryOffload.queue.resultStream": "Summary Offload Result Stream",
  "agents.defaults.compaction.summaryOffload.queue.consumerGroup": "Summary Offload Consumer Group",
  "agents.defaults.compaction.summaryOffload.queue.consumerName": "Summary Offload Consumer Name",
  "agents.defaults.compaction.summaryOffload.queue.blockMs": "Summary Offload Block (ms)",
  "agents.defaults.compaction.summaryOffload.queue.claimIdleMs": "Summary Offload Claim Idle (ms)",
  "agents.defaults.compaction.summaryOffload.retry.initialDelayMs":
    "Summary Offload Retry Initial (ms)",
  "agents.defaults.compaction.summaryOffload.retry.maxDelayMs": "Summary Offload Retry Max (ms)",
  "agents.defaults.compaction.summaryOffload.circuitBreaker.failureThreshold":
    "Summary Offload Failure Threshold",
  "agents.defaults.compaction.summaryOffload.circuitBreaker.pauseMs": "Summary Offload Pause (ms)",
  "agents.defaults.compaction.summaryOffload.pendingContext": "Summary Offload Pending Context",
  "agents.defaults.compaction.summaryOffload.summaryCharLimit": "Summary Offload Char Limit",
  "agents.defaults.compaction.summaryOffload.timeoutMs": "Summary Offload Timeout (ms)",
  "agents.defaults.compaction.summaryOffload.logSampleRate": "Summary Offload Log Sample Rate",
